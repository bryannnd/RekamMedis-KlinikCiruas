...
export default function Index({ polikliniks, filters }) {
    ...
    const columns = [
        { label: 'Kode Poli', key: 'kd_poli' },
        { label: 'Nama Poliklinik', key: 'nm_poli' },
        { label: 'Lantai', key: 'lantai' },
    ];

    const actions = (row) => (
        <div className="flex justify-end gap-2">
            <Link
                href={route('polikliniks.edit', row.kd_poli)}
            ...
            <button
                onClick={() => {
                    if (confirm('Are you sure you want to delete this poliklinik?')) {
                        router.delete(route('polikliniks.destroy', row.kd_poli));
                    }
                }}
    ...
    return (
        <AuthenticatedLayout header="Data Poliklinik">
