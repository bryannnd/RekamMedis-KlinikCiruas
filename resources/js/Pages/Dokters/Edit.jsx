...
export default function Edit({ dokter, polikliniks }) {
    const { data, setData, put, processing, errors } = useForm({
        nm_dokter: dokter.nm_dokter,
        kd_poli: dokter.kd_poli,
        sip: dokter.SIP || '', // Handle nullable
        tempat_lhr: dokter.tempat_lhr || '',
        no_tlp: dokter.no_tlp,
        alamat: dokter.alamat,
    });

    const submit = (e) => {
        e.preventDefault();
        put(route('dokters.update', dokter.kd_dokter));
    };

    return (
        <AuthenticatedLayout header="Edit Dokter">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                <form onSubmit={submit} className="max-w-4xl">
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        <div>
                            <InputLabel htmlFor="kd_dokter" value="Kode Dokter" />
                            <TextInput
